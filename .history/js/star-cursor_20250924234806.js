...
(function () {
  ...
  // CONFIG
  // -----------------------
  const UPWARD = false; // set to false if you want falling stars
  const MAX_STARS = 250; // cap particle count
  const SPAWN_THROTTLE = 16; // ms between spawns (approx 60 FPS)
  const DURATION_MS = 2000; // time to shrink to final size
